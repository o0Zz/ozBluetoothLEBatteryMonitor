...
namespace PeripheralBatteryMonitor
{
    public partial class Settings : Form
    {
        ...
        public Settings()
        {
            ...
            Registry.CurrentUser.CreateSubKey("SOFTWARE\\PeripheralBatteryMonitor");
            ...
            rk = Registry.CurrentUser.OpenSubKey("SOFTWARE\\PeripheralBatteryMonitor", false);
        ...
        public void Notify(string message, ToolTipIcon icon = ToolTipIcon.Info)
        {
            if (checkBoxNotification.Checked)
                NotifyIcon.ShowBalloonTip(300, "Peripheral Battery Monitor", message, icon);
        }
        ...
        private void numericUpDownRefreshPeriod_ValueChanged(object sender, EventArgs e)
        {
            ...
            RegistryKey rk = Registry.CurrentUser.OpenSubKey("SOFTWARE\\PeripheralBatteryMonitor", true);
